        ...
        <div class="row  flex-items-xs-between flex-items-xs-middle">
          ...
          <div class="col-xs-6 text-xs-right" id="textf">
            ...
            <a class="login hidden-xs-down text-uppercase font-weigth-bold" href="{{ url('/logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
              <img src="CelularesPeru/imagenes/salirmenuf.png" id="imagf">
              Salir
            </a>
          ...
          <div class="row">
            <div class="col-xs-12 col-lg-9" id="div-nav">
              <ul class="nav navbar-nav" id="nav-f" >
                ...
                <li class="nav-item text-xs-center">
                  <a href="{{url('/carrito')}}" class="nav-link"><img src="CelularesPeru/imagenes/mcarrito1.png"> Carrito <span>{{$productsCount}}</span></a>
                </li>
                <li class="nav-item text-xs-center">
                  <a href="{{url('/nosotros')}}" class="nav-link active"><img src="CelularesPeru/imagenes/mnosotros3.png"> Nosotros</a>
                </li>
                <li class="nav-item text-xs-center">
                ...
                <li class="nav-item text-xs-center hidden-sm-up">
                  <a class="nav-link" href="{{ url('/logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                    <img src="CelularesPeru/imagenes/salida.png">
                    Salir
                  </a>
                  <form id="logout-form" action="{{ url('/logout') }}" method="POST" style="display: none;">
                    {{ csrf_field() }}
